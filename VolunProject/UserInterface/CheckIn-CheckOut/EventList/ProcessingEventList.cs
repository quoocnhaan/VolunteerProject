...
{
    public partial class ProcessingEventList : UserControl
    {
        public ProcessingEventList()
        {
            InitializeComponent();
            PopulateCardList();
        }
        private void PopulateCardList()
        {
            ...
            {
                ProcessingEventControl.ProcessingEventControl cardControl = new ProcessingEventControl.ProcessingEventControl(cardText);
                EventflowLayoutPanel.Controls.Add(cardControl);
            }
            eventPanel.Controls.Add(EventflowLayoutPanel);
        }
    }
}
